...
<div id="Background-home" class="absolute w-full h-full top-0 bg-white">
    ...
    >
        ...
        class="absolute right-0 top-[147px] object-contain max-h-[481px]"
...
@section('content')
    ...
    <div
      id="Hero-Text"
      class="relative flex flex-col w-full max-w-[1280px] px-[75px] mx-auto gap-[30px] mt-[86px]"
    >
      <div
        class="Badge flex items-center w-fit rounded-full p-[8px_14px] gap-[10px] bg-white"
      >
        <img
      ...
      <p class="text-lg leading-8">
        Your truly great experience starts here with us <br />that lorem dolor
        amet si package exclusively matter.
      </p>
    </div>
    <form
      action="{{ route ('flight.index')}}" method="GET"
    ...
    >
      <div class="flex flex-col rounded-[30px] p-[30px] gap-4 bg-white">
        ...
        <div class="flex items-center gap-5">
          <div
            class="grid grid-cols-4 items-center rounded-[20px] border border-[#E8EFF7]"
          >
            <div
              id="Departure"
            ...
            >
              ...
              >
                ...
                <div class="text-left">
                  ...
                  <p
                    id="Departure-Label"
                    class="font-semibold text-lg mt-[2px] text-nowrap"
                  >
                    Select Departure
                  </p>
                </div>
              ...
              >
                <div
                  class="flex flex-col justify-center w-[483px] p-5 gap-4 shrink-0"
                >
              ...
              >
                ...
                />
                <img
                  src="assets/images/icons/airplane-black.svg"
            ...
            >
              <button
                type="button"
                class="dropdown flex items-center gap-4 p-5 first:pl-6 last:pr-6"
            ...
            >
              ...
              <div
                ...
                class="dropdown-content hidden absolute z-10 top-full mt-4"
              >
                <div
                ...
                >
                  <button
                    type="button"
                    id="minus"
                    class="w-[38px] h-[38px] flex shrink-0"
                  >
          ...
          >
            <img
              src="assets/images/icons/search-status-white.svg"
              class="flex shrink-0 w-[30px]"
              alt="icon"
            />
    ...
    <section
      id="Popular"
      class="relative flex flex-col gap-[30px] mt-[70px] mb-[86px]"
    >
      ...
      <div class="swiper !w-full overflow-x-hidden">
        <div class="swiper-wrapper">
          ...
          @foreach ($airports as $airport)
          <div
          class="swiper-slide !w-fit first:ml-[calc(((100%-1280px)/2)+75px-24px)]"
        >
          <a href="#" class="card">
            <div
            ...
            >
              ...
              >
                <img
                  src="assets/images/icons/global-black.svg"
