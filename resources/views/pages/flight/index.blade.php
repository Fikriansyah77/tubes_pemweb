...
@section('content')
<main
      class="relative flex flex-col w-full max-w-[1280px] px-[75px] mx-auto mt-[50px] mb-[62px]"
    >
      ...
      <div class="flex gap-[26px] mt-[30px]">
        ...
        <div
          id="Result"
          class="flex flex-col w-full h-fit rounded-3xl p-5 gap-5 bg-white"
        >
          ...
          >
            <label class="accordion-trigger flex items-center justify-between">
              ...
              <div class="flex items-center gap-[10px]">
                <img
                src="{{asset('storage/'.$flight->airline->logo)}}"
              ...
              <p
              class="min-w-[120px] font-semibold text-garuda-green text-center"
            >
              {{'Rp. ' . number_format($flight->classes->first()->price, 0, ',', '.') }}
            </p>
              <a
                href="{{route('flight.show', $flight->flight_number)}}"
            ...
            <div class="accordion-content flex justify-between">
              <div class="left-content flex flex-col gap-[10px]">
                ...
                <div class="transit flex items-center gap-5">
                  ...
                  <div class="flex items-center gap-4">
                    <img
                      src="assets/images/icons/transit-round-black.svg"
                      class="w-[50px] h-[50px] flex shrink-0"
                      alt="icon"
                    />
                    <div>
            ...
            <div class="left-content flex flex-col gap-[10px]">
              ...
              <div class="time flex flex-col items-center w-[83px]">
                <div
                  class="h-8 border border-garuda-black border-dashed"
                ></div>
                <p class="text-xs leading-[18px] text-garuda-grey"> {{number_format($flight->segments->first()->time->diffInHours($flight->segments->last()->time), 0)}}
                  Hours</p>
                <div
                  class="h-8 border border-garuda-black border-dashed"
                ></div>
